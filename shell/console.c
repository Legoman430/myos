...
//Funtion that updates cursor position
void update_cursor() {
...
//Functions that clears the terminal
void clear_terminal() {
...
//Function to set terminal font color
void set_terminal_font_color(VGA_Color col) {
     terminal_font_color = col;
}

//Function to set backgroud color for the terminal
...
//Function to print the line with color
